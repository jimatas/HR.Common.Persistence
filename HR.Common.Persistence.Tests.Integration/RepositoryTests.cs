...
using HR.Common.Persistence.Tests.Integration.Fixture;
...
namespace HR.Common.Persistence.Tests.Integration
{
    [TestClass]
    public class RepositoryTests
    {
        ...
        public void Initialize()
        {
            ...
            services.AddDbContext<SampleDbContext>(
                dbContext => dbContext.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=HRCommonPersistence_TestDb;Trusted_Connection=true;MultipleActiveResultSets=true"),
